  ...
  <el-card class="input-card">
    <template #header>
      <div class="card-header">
        ...
        <el-radio-group
          :model-value="predictMode"
          size="small"
          @update:model-value="emit('update:predictMode', $event)"
        >
    ...
    >
      <el-form-item label="输入文本">
        <el-input
          :model-value="predictForm.text"
          type="textarea"
          :rows="4"
          placeholder="请输入需要分析的微博内容或评论文本..."
          maxlength="1000"
          show-word-limit
          @update:model-value="emit('update:predictForm', { ...predictForm, text: $event })"
        />
      </el-form-item>
      <el-form-item>
        <el-button
